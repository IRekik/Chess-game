...
public class Main {
	...
	public static String pieceToString (Piece p) {
		...
		else if (p.getClass().getName().equals("Rook")) {
			return "R";
		}
		else if(p.getClass().getName().equals("Bishop")) {
			return "B";
		}
		else if (p.getClass().getName().equals("Knight")) {
			return "N";
		}
		else if (p.getClass().getName().equals("King")) {
			return "K";
		}
		else if (p.getClass().getName().equals("Queen")) {
			return "Q";
		}
		return null;
	}
